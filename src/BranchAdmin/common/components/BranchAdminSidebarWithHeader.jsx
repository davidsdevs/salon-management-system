...
const BranchAdminSidebarWithHeader = ({ userInfo, pageTitle, children }) => {
  ...
  const menuItems = [
    { name: "Dashboard", icon: LayoutDashboard, route: "/branch-admin-dashboard" },
    { name: "Branch Settings", icon: Building2, route: "/branch-admin-settings" },
    { name: "Staff Management", icon: Users, route: "/branch-admin-staff" },
    { name: "Scheduling", icon: Calendar, route: "/branch-admin-scheduling" },
    { name: "Financial Management", icon: CreditCard, route: "/branch-admin-financial" },
    { name: "Reports", icon: FileText, route: "/branch-admin-reports" },
    { name: "Profile", icon: User, route: "/branch-admin-profile" }
  ]
...
export default BranchAdminSidebarWithHeader
