        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-16 lg:gap-20 justify-items-center md:justify-items-start">
          <div className="text-center md:text-left">
            ...
            <p className="text-gray-600 text-base leading-relaxed max-w-sm mx-auto md:mx-0">
              Premium hair and beauty services across 7 locations in the Philippines. Each branch offers
              specialized services for our local communities.
            </p>
          </div>
          ...
          <div className="text-center md:text-left">
            ...
            <ul className="space-y-2 text-base text-gray-600">
              <li>
                <a href="#" className="hover:text-[#160B53]">
                  Our Branches
                </a>
              </li>
              <li>
