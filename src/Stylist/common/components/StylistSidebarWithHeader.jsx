...
const StylistSidebarWithHeader = ({ userInfo, pageTitle, children }) => {
  ...
  const menuItems = [
    { name: "Dashboard", icon: LayoutDashboard, route: "/stylist-dashboard" },
    { name: "Appointments", icon: Calendar, route: "/stylist-appointments" },
    { name: "Clients", icon: Users, route: "/stylist-clients" },
    { name: "Services", icon: Scissors, route: "/stylist-services" },
    { name: "Schedule", icon: Clock, route: "/stylist-schedule" },
    { name: "Profile", icon: User, route: "/stylist-profile" }
  ]
...
export default StylistSidebarWithHeader
