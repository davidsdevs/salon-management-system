...
const ReceptionistSidebarWithHeader = ({ userInfo, pageTitle, children }) => {
  ...
  const menuItems = [
    { name: "Dashboard", icon: LayoutDashboard, route: "/receptionist-dashboard" },
    { name: "Appointments", icon: Calendar, route: "/receptionist-appointments" },
    { name: "Clients", icon: Users, route: "/receptionist-clients" },
    { name: "Walk-ins", icon: Phone, route: "/receptionist-walkins" },
    { name: "Payments", icon: CreditCard, route: "/receptionist-payments" },
    { name: "Schedule", icon: Clock, route: "/receptionist-schedule" },
    { name: "Profile", icon: User, route: "/receptionist-profile" }
  ]
...
export default ReceptionistSidebarWithHeader
